...
namespace CalamityOverhaul.Content.ADV.Scenarios.VoidColonys.Strongholds
{
    ...
    /// 零号站点：双层桥基前�?
    /// 上层由信号塔+左右实验室构成主要作战平�?
    /// 下层比上层更宽、更密集的炮台群，通过两侧铁锈阶梯与上层形成Z型闭合结�?
    /// </summary>
    internal class ZeroSiteStronghold : Stronghold
    {
        ...
        //双层垂直落差px，等于一段铁锈阶梯端口的Y差（188-42=146�?
        private const int DeckGapPx = StairLowLocalY - StairHighLocalY;
        //下层桥在阶梯低端外再延伸的长度，给两端留足炮台阵列空�?
        ...
        /// <summary>
        /// 下层走廊与连接阶�?
        /// 左侧阶梯原朝�?低左高右)：高端挂到上层左实验室左端口，低端落到下层左�?
        /// 右侧阶梯镜像�?高左低右)：高端挂到上层右实验室右端口，低端落到下层右�?
        ...
        /// <summary>
        /// �?leftX,rightX)桥段上等距分布若干炮台，全部统一朝向
        /// </summary>
